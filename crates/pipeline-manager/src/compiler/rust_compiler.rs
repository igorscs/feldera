use crate::compiler::util::{
    ...
    create_new_file_with_content, decode_string_as_dir, pipeline_binary_filename,
    program_info_filename, read_file_content, recreate_dir, recreate_file_with_content,
